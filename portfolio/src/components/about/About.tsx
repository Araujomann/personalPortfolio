            ...
            <div className=" flex flex-col pt-6 w-full gap-5 text-center">
                ...
                <div className="flex items-center">
                    ...
                    <p className="text-black w-48 mx-auto font-silks text-[10px] md:text-[16px] md:w-60">
                        Entrei na empresa júnior do ifma, que nasceu da minha
                        turma e tive a opourtunidade de ser lider do grupo de front-end,
                        organizando o roteiro de estudos e ajudando os demais membros com dúvidas que surgiam.
                    </p>
                </div>

                <div className="flex items-center">
                    <img src={js} alt="js logo" className="w-20 ml-4  md:w-32 " />
                    <p className="text-black w-40 mx-auto font-silks text-[10px] md:text-[16px] md:w-60">deixei a empresa júnior quando consegui minha primeira vaga de emprego.</p>
                </div>
            </div>
