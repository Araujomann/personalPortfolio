...
const AvatarModel = ({ scale }: AvatarModelProps) => {
    const gltf = useLoader(GLTFLoader, 'https://models.readyplayer.me/66da0adde0b85c8ace8cbc5a.glb');
...
export const Avatar = () => {
    ...
    return (
        <Canvas className="w-full h-full" camera={{ position: [0, scale, scale * 2] }}>
