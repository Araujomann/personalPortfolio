...
export const Works = () => {
    return (
        <div className=" relative flex flex-col i w-11/12 p-6 md:h-160 md:w-10/12 lg:mt-12 xl:mt-0">
            ...
            <div className="flex  p-2 gap-2 md:gap-8 place-content-center 2xl:gap-16">
                ...
                <div className="relative -top-14 h-50 w-30 flex flex-col  md:h-52  md:w-28 2xl:w-36 2xl:h-60">
                    <div className="bg-blueImageProject h-full flex">
                        <img src={projectTwo} className="my-auto" />
                    </div>
