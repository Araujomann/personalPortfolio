...
export const Works:React.FC<Props> = ({id}) => {
    return (
        <div id={id} className=" relative flex flex-col w-11/12  md:h-160 md:w-10/12 lg:mt-12 xl:mt-0">
            <h1 className="relative  w-full z-10 left-0 top-0 mb-3 font-anton text-greenTitle md:text-8xl">
                WORKS
            </h1>

            <p className="  absolute right-0 top-0 text-black text-[8px] text-right tracking-tight font-silks w-36 md:text-[12px] md:w-48 md:left-64 md:-top-28 xl:w-64 xl:-top-24 xl:left-72 2xl:text-[16px] 2xl:w-80 2xl:-top-28 ">durante minha vida acadêmica e profissional, tive a oportunidade de trabalhar com uma variedade de projetos.</p>
            <div className="flex  p-2 gap-2 md:gap-8 place-content-center 2xl:gap-16 ">
                ...
                <div className="relative top-0 h-40 w-30 flex flex-col  md:h-52  md:w-28 2xl:w-36 2xl:h-60">
