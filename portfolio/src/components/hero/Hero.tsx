...
export const Hero: React.FC<Props> = ({ id }) => {
  ...
  return (
    <div
      id={id}
      className="group z-10 relative overflow-hidden bg-bege w-11/12 mt-4 mb-8 h-128 flex justify-center md:h-192 md:w-full xl:h-208 2xl:h-176"
    >
      <Header />
      ...
      />
      <img
        className="object-cover transition-transform hover:origin-bottom duration-500 ease-in-out hover:scale-105 z-10 absolute h-30 w-30 mt-72 brightness-90 lg:bottom-0 lg:mt-64 xl:mt-36 2xl:mt-3 hidden md:hidden lg:block"
        src={myPhotoLarge}
        alt="Lucas"
      />
